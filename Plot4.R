...
with(data_sub, {
  ...
  plot(data_sub$Time, data_sub$Voltage, type="l", ylab = "Voltage",xlab = "datetime", main = "Voltage vs Time")
  ...
  plot(data_sub$Time, data_sub$Global_reactive_power, type="l", ylab = "Global_reactive_power",xlab = "datetime", main = "Global Reactive Power vs Time")
})
